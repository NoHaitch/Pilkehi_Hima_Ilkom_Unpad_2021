        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav col-lg-12 d-flex flex-lg-row justify-content-lg-end">
                    ...
                    <button type="button" onclick="logout()" class="btn btn-outline-light h6">LOGOUT</button>
                </li>
                </ul>
            </div>
        </div>
    ...
    <main class="min-vh-100 bg-light py-5" id="calonKetua">
        <div class="container d-flex flex-column align-items-center justify-content-center">
            <div class="d-flex flex-column flex-lg-row justify-content-center">
                <div class="my-5 col-lg-3 mx-5 d-flex flex-column align-items-center border-bottom pb-2 border-3 border-secondary" id="wrapperSatu">
                    <img onclick="pilih(1)" src="../src/calon/Calon 1/calon-1.png" alt="" class="logo my-2 foto-calon" id="nomorSatu">
                ...
                <div class="my-5 col-lg-3 mx-5 d-flex flex-column align-items-center border-bottom pb-2 border-3 border-secondary" id="wrapperDua">
                    <img onclick="pilih(2)" src="../src/calon/Calon 2/calon-2-rev.png" alt="" class="logo my-2 foto-calon" id="nomorDua">
                ...
                <div class="my-5 col-lg-3 mx-5 d-flex flex-column align-items-center border-bottom pb-2 border-3 border-secondary" id="wrapperTiga">
                    <img onclick="pilih(3)" src="../src/calon/Calon 3/calon-3-rev.png" alt="" class="logo my-2 foto-calon" id="nomorTiga">
            ...
            <button onclick="kirim()" class="btn btn-secondary py-2 mt-3 col-lg-2 text-light col-6">Kirim Suara</button>
        </div>
        <div style="display:none">
            <form action="kirimdata.php" method="POST"> 
                <input type="radio" id="1" name="pilihan" value="calon1">
                <input type="radio" id="2" name="pilihan" value="calon2">
                <input type="radio" id="3" name="pilihan" value="calon3">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
					...
					<h5 class="h5 text-secondary">Growth</h5>
                    <p class="p-small">
                        Hima Humas dapat terus meningkatkan pencapaian dan performanya melalui implementasi evaluasi. Hima Humas juga bertanggung jawab dan menggunakan fakta & data untuk mencapai tujuan bersamanya. 
                    </p>
					<h5 class="h5 text-secondary">Agility</h5>
                    <p class="p-small">
                        Hima Humas dapat sigap dalam mengatasi permasalahan & perubahan situasi, berproses dengan konsisten, dan fleksibel serta berkembang sesuai kebutuhannya.
                    </p>
					<h5 class="h5 text-secondary">Visionary</h5>
                    <p class="p-small">
                        Hima Humas dapat berpikir panjang ketika membuat keputusan dan perencanaan sehingga dapat memberikan dampak yang berkelanjutan. Hima Humas juga terbuka pada kesempatan-kesempatan baru.
                    </p>
					<h5 class="h5 text-secondary">Empathy</h5>
                    <p class="p-small">
                        Hima Humas peduli dan mempertimbangkan publik internal dan eksternalnya dalam pembuatan keputusan dan perencanaan. Hima Humas juga menghargai pendapat pihak lain dan saling membantu dalam mencapai tujuannya.
                    </p>
                </div>
            </div>
